...
class RoundingPolicyTest {
    ...
    void shouldRoundCostWithScaleSixAndHalfUp() {
        ...
        assertThat(roundedCost.value()).isEqualByComparingTo("0.000001");
        assertThat(roundedCost.value().scale()).isEqualTo(6);
    ...
    void shouldPreserveCurrencyWhenRoundingCost() {
        ...
        assertThat(roundedCost.value()).isEqualByComparingTo("12.345679");
